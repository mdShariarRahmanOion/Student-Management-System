...
void loading()
{
    SetConsoleTitle("Student Management System || BUBT");
    int r,q;
    gotoxy(40,10);
    setcolor(1);
    printf("LOADING......");
...
void login()
{
    ...
    {
        printf("\n\n\t!!!! ERROR !!!!Wrong Password Or User Name Please Enter Valid Password And User Name");
...
void modify(FILE *fp)
{
    ...
    if(flag==1)
    {
        ...
        printf("\n\t\tDepartment: %s",s.dept);
        printf("\n\t\tStudent Intake: %d",s.intake);
        printf("\n\t\tStudent Section: %d",s.sec);
        printf("\n\t\tStudent Roll: %d\n\t\t\t",s.roll);
        printChar('=',38);
